...
Item {
    ...
    function update(lang) {
        if (_settings_dialog.getLanguageForQml() === "de") {
            ...
            help_screen_info_text1.text = "Dieses Programm unterliegt der GPL v3 Lizenz. Es kann frei verwendet und verändert werden, muss allerdings stets unter GPL Lizenz veröffentlicht werden. Es verwendet das Qt Framework (version 6). \n\n2022 by Sebastian Schäfer -- web: http://hel800.github.io/picture-show2/"
            ...
            help_screen_info_text1.text = "This application is published under the GPL v3 licence. It can be used and modified freely, but has to be remain published under the GPL at all times. The Qt Framework (version 6) is used. \n\n2022 by Sebastian Schäfer -- web: http://hel800.github.io/picture-show2/"
        }
    }
...
//            anchors.topMargin: parent.height - parent.height / 10
            ...
            Text {
                ...
                smooth: true;
                wrapMode: Text.Wrap
                text: "Dieses Programm unterliegt der GPL v3 Lizenz. Es kann frei verwendet und verändert werden, muss allerdings stets unter GPL Lizenz veröffentlicht werden. Es verwendet das Qt Framework (version 6). \n\n2022 by Sebastian Schäfer -- web: http://hel800.github.io/picture-show2/"
            }
        }
    }
